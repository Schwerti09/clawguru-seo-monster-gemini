...
export type Dictionary = {
  ...
  previews: {
    ...
    avgDuration: string
    summonDesc: string
    summonPlaceholder: string
    summonDefaultQuery: string
    summonEx1: string
    summonEx2: string
    summonEx3: string
    summonCounter: string
    summonSearching: string
    summonError: string
    summonNoResults: string
    summonReduces80: string
    summonProtects: string
    summonBaseHardening: string
    summonHighRelevance: string
    summonMediumMatch: string
    summonLowMatch: string
    oracleDesc: string
    oracleInit: string
    oracleActive: string
    oracleNext: string
    oracleSafety: string
    oracleInputLabel: string
    oraclePlaceholder: string
    oracleAnalyze: string
    oraclePatchNow: string
    oracleRunbook: string
    oracleNotify: string
    oracleDetails: string
    oracleWarning: string
    neuroDesc: string
    neuroStackLabel: string
    neuroAccuracy: string
    neuroError: string
    neuroLoading: string
    neuroPlanLabel: string
    neuroNoResults: string
    neuroBenefitAws: string
    neuroBenefitNginx: string
    neuroBenefitPostgres: string
    neuroBenefitDefault: string
    neuroSecureIn: string
    myceliumDesc: string
    myceliumInit: string
    myceliumCounter: string
    myceliumFullscreen: string
    myceliumCaption: string
    myceliumExplore: string
    checkTitle: string
    checkDesc: string
    ...
    checkScoreExcellent: string
    checkScoreSolid: string
    checkScoreVulnerable: string
    checkScoreCritical: string
    checkHintExcellent: string
    checkHintSolid: string
    checkHintVulnerable: string
    checkHintCritical: string
    checkHigherRisk: string
    checkNextSteps: string
    checkShareBadge: string
    checkCopyLink: string
    checkSharePreview: string
    checkDownloadSvg: string
    checkError: string
    checkRetry: string
    checkNoStorage: string
    checkHeuristic: string
    checkConfigHint: string
    checkRiskImmediate: string
    checkRiskDesc: string
    checkBtnPro: string
    checkBtnDayPass: string
    checkBtnAllPlans: string
    checkOpenDashboard: string
    checkSeeProTeam: string
    checkShareMsg: string
    checkImproveTitle90: string
    checkImproveTitle75: string
    checkImproveTitle: string
    checkImproveDesc90: string
    checkImproveDesc75: string
    checkImproveDesc: string
    checkCopilotExposed: string
    checkCopilotHarden: string
  }
}
