...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="628" viewBox="0 0 1200 628">
  ...
  <text x="100" y="390" font-size="34" font-family="Inter, Arial, sans-serif" fill="#00ff9d" font-weight="700">${escapeXml(name)}</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="850" viewBox="0 0 1200 850">
  ...
  <text x="600" y="340" text-anchor="middle" font-size="40" font-family="Inter, Arial, sans-serif" fill="#00ff9d" font-weight="700">${escapeXml(name)}</text>
...
export async function GET(req: NextRequest) {
  ...
  // Limit name length to keep text inside the SVG layout bounds; 48 chars fits the
  // 1200px layout at current font size. Wide glyphs may still clip, so shorter
  // names are recommended for best visual results.
