...
export const UI_STRINGS: Record<Locale, Record<string, string>> = {
  de: {
    ...
    shareUnlockTitle: "{count} extra Schritte freischalten",
    shareUnlockShareX: "Auf 𝕏 teilen",
    shareUnlockShareLinkedin: "Auf LinkedIn teilen",
    shareUnlockEmailPlaceholder: "you@company.com",
    shareUnlockEmailButton: "Per Email freischalten",
    shareUnlockLoading: "Freischalten…",
    shareUnlockError: "Bitte eine gültige Email-Adresse angeben.",
    shareUnlockSuccess: "Freigeschaltet. Viel Erfolg mit dem Runbook!",
    affiliateKicker: "Affiliate Onboarding",
    affiliateTitle: "Partner Registrierung",
    affiliateSubtitle: "Sofort nach dem Signup erzeugen wir deine personalisierten Banner in 10 Sprachen.",
    affiliateNamePlaceholder: "Name",
    affiliateCompanyPlaceholder: "Company",
    affiliateEmailPlaceholder: "Email",
    affiliateActivateButton: "Partner aktivieren",
    affiliateLoading: "Registriere...",
    affiliateError: "Signup fehlgeschlagen. Bitte erneut versuchen.",
  ...
  en: {
    ...
    shareUnlockTitle: "Unlock {count} extra steps",
    shareUnlockShareX: "Share on 𝕏",
    shareUnlockShareLinkedin: "Share on LinkedIn",
    shareUnlockEmailPlaceholder: "you@company.com",
    shareUnlockEmailButton: "Unlock via Email",
    shareUnlockLoading: "Unlocking…",
    shareUnlockError: "Please enter a valid email address.",
    shareUnlockSuccess: "Unlocked. Good luck with the runbook!",
    affiliateKicker: "Affiliate Onboarding",
    affiliateTitle: "Partner Registration",
    affiliateSubtitle: "We generate your personalized banners in 10 languages right after signup.",
    affiliateNamePlaceholder: "Name",
    affiliateCompanyPlaceholder: "Company",
    affiliateEmailPlaceholder: "Email",
    affiliateActivateButton: "Activate partner",
    affiliateLoading: "Registering...",
    affiliateError: "Signup failed. Please try again.",
    affiliateIdLabel: "Affiliate ID",
    affiliateLinkLabel: "Affiliate link",
  },
  es: {
