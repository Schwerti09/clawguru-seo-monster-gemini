type LinkablePage = {
  ...
  title?: string
  tags?: string[]
  clawScore?: number // expected 0-100 authority hint
}
    ...
    getLinks(target: T): LinkEngineLink[] {
      ...
      const scored = normalized
        ...
        .map(({ page, tagSet }) => {
          ...
          return { page, score: shared * TAG_SIMILARITY_MULTIPLIER + authority / AUTHORITY_SCALE_FACTOR }
        })
