...
export const UI_STRINGS: Record<Locale, Record<string, string>> = {
  de: {
    ...
    pricingTaxIncluded: "inkl. lokale Steuern",
    affiliateWarRoom: "Affiliate War-Room",
    affiliateTitle: "Top Affiliate Partner",
    affiliateSubtitle: "Anonymisierte Rangliste der erfolgreichsten Partner mit echten Auszahlungen.",
    affiliateRank: "#",
    affiliatePartner: "Partner",
    affiliateReferrals: "Leads",
    affiliateRegion: "Region",
    affiliatePayout: "Auszahlung",
    affiliateCtaTitle: "Willst du hier stehen?",
    affiliateCtaBody: "Teile Runbooks, bringe neue Teams – wir zahlen pro aktivem Kunden.",
    affiliateCtaButton: "Affiliate starten →",
    affiliateCtaSecondary: "Dashboard öffnen",
    quickFixWidgetTitle: "Quick-Fix Widget",
    quickFixWidgetSubtitle: "Starte einen Sofort-Fix für dieses Issue.",
    quickFixWidgetCta: "Fix öffnen →",
  },
  en: {
    runbooks: "Runbooks",
    providers: "Providers",
    ...
    pricingTaxIncluded: "incl. local taxes",
    affiliateWarRoom: "Affiliate War-Room",
    affiliateTitle: "Top Affiliate Partners",
    affiliateSubtitle: "Anonymous ranking of the highest-performing partners with real payouts.",
    affiliateRank: "#",
    affiliatePartner: "Partner",
    affiliateReferrals: "Referrals",
    affiliateRegion: "Region",
    affiliatePayout: "Payout",
    affiliateCtaTitle: "Want to be on this list?",
    affiliateCtaBody: "Share runbooks, bring new teams — we pay per active customer.",
    affiliateCtaButton: "Start affiliate →",
    affiliateCtaSecondary: "Open dashboard",
    quickFixWidgetTitle: "Quick-Fix Widget",
    quickFixWidgetSubtitle: "Launch an instant fix for this issue.",
    quickFixWidgetCta: "Open fix →",
  },
  es: {
    runbooks: "Runbooks",
    ...
    pricingTaxIncluded: "incl. impuestos locales",
    affiliateWarRoom: "Sala de Guerra de Afiliados",
    affiliateTitle: "Top Socios Afiliados",
    affiliateSubtitle: "Ranking anónimo de los socios con mejores resultados y pagos reales.",
    affiliateRank: "#",
    affiliatePartner: "Socio",
    affiliateReferrals: "Referidos",
    affiliateRegion: "Región",
    affiliatePayout: "Pago",
    affiliateCtaTitle: "¿Quieres aparecer aquí?",
    affiliateCtaBody: "Comparte runbooks, trae nuevos equipos: pagamos por cliente activo.",
    affiliateCtaButton: "Iniciar afiliado →",
    affiliateCtaSecondary: "Abrir panel",
    quickFixWidgetTitle: "Widget Quick-Fix",
    quickFixWidgetSubtitle: "Lanza un arreglo instantáneo para este issue.",
    quickFixWidgetCta: "Abrir fix →",
  },
  fr: {
    runbooks: "Runbooks",
    ...
    pricingTaxIncluded: "taxes locales incluses",
    affiliateWarRoom: "War-Room Affiliés",
    affiliateTitle: "Top Partenaires Affiliés",
    affiliateSubtitle: "Classement anonyme des partenaires les plus performants avec des paiements réels.",
    affiliateRank: "#",
    affiliatePartner: "Partenaire",
    affiliateReferrals: "Parrainages",
    affiliateRegion: "Région",
    affiliatePayout: "Paiement",
    affiliateCtaTitle: "Envie d'apparaître ici ?",
    affiliateCtaBody: "Partagez des runbooks, apportez des équipes — paiement par client actif.",
    affiliateCtaButton: "Démarrer l'affiliation →",
    affiliateCtaSecondary: "Ouvrir le dashboard",
    quickFixWidgetTitle: "Widget Quick-Fix",
    quickFixWidgetSubtitle: "Lancez un correctif instantané pour ce problème.",
    quickFixWidgetCta: "Ouvrir le fix →",
  },
  ...
  pt: {
    ...
    pricingTaxIncluded: "inclui impostos locais",
    affiliateWarRoom: "War-Room de Afiliados",
    affiliateTitle: "Top Parceiros Afiliados",
    affiliateSubtitle: "Ranking anônimo dos parceiros com melhor desempenho e pagamentos reais.",
    affiliateRank: "#",
    affiliatePartner: "Parceiro",
    affiliateReferrals: "Indicações",
    affiliateRegion: "Região",
    affiliatePayout: "Pagamento",
    affiliateCtaTitle: "Quer aparecer aqui?",
    affiliateCtaBody: "Compartilhe runbooks, traga novos times — pagamos por cliente ativo.",
    affiliateCtaButton: "Começar afiliação →",
    affiliateCtaSecondary: "Abrir dashboard",
    quickFixWidgetTitle: "Widget Quick-Fix",
    quickFixWidgetSubtitle: "Inicie um conserto instantâneo para este issue.",
    quickFixWidgetCta: "Abrir fix →",
  },
  ...
  it: {
    ...
    pricingTaxIncluded: "incl. tasse locali",
    affiliateWarRoom: "War-Room Affiliati",
    affiliateTitle: "Top Partner Affiliati",
    affiliateSubtitle: "Classifica anonima dei partner più performanti con pagamenti reali.",
    affiliateRank: "#",
    affiliatePartner: "Partner",
    affiliateReferrals: "Referral",
    affiliateRegion: "Regione",
    affiliatePayout: "Pagamento",
    affiliateCtaTitle: "Vuoi essere qui?",
    affiliateCtaBody: "Condividi runbook, porta nuovi team — paghiamo per cliente attivo.",
    affiliateCtaButton: "Avvia affiliazione →",
    affiliateCtaSecondary: "Apri dashboard",
    quickFixWidgetTitle: "Widget Quick-Fix",
    quickFixWidgetSubtitle: "Avvia un fix istantaneo per questo issue.",
    quickFixWidgetCta: "Apri fix →",
  },
  ...
  ru: {
    ...
    pricingTaxIncluded: "вкл. местные налоги",
    affiliateWarRoom: "Affiliate War-Room",
    affiliateTitle: "Топ партнёров",
    affiliateSubtitle: "Анонимный рейтинг лучших партнёров с реальными выплатами.",
    affiliateRank: "#",
    affiliatePartner: "Партнёр",
    affiliateReferrals: "Рефералы",
    affiliateRegion: "Регион",
    affiliatePayout: "Выплата",
    affiliateCtaTitle: "Хотите попасть сюда?",
    affiliateCtaBody: "Делитесь runbook, приводите команды — платим за активного клиента.",
    affiliateCtaButton: "Стать партнёром →",
    affiliateCtaSecondary: "Открыть дашборд",
    quickFixWidgetTitle: "Виджет Quick-Fix",
    quickFixWidgetSubtitle: "Запустите мгновенный фикс для этой проблемы.",
    quickFixWidgetCta: "Открыть фикс →",
  },
  ...
  zh: {
    ...
    pricingTaxIncluded: "含当地税费",
    affiliateWarRoom: "联盟战情室",
    affiliateTitle: "顶级联盟伙伴",
    affiliateSubtitle: "匿名排名，展示最高绩效伙伴及真实收益。",
    affiliateRank: "#",
    affiliatePartner: "伙伴",
    affiliateReferrals: "推荐",
    affiliateRegion: "地区",
    affiliatePayout: "支付",
    affiliateCtaTitle: "想上榜吗？",
    affiliateCtaBody: "分享runbook、带来新团队——我们按活跃客户支付。",
    affiliateCtaButton: "加入联盟 →",
    affiliateCtaSecondary: "打开仪表板",
    quickFixWidgetTitle: "Quick-Fix 小组件",
    quickFixWidgetSubtitle: "为此问题启动即时修复。",
    quickFixWidgetCta: "打开修复 →",
  },
  ...
  ja: {
    ...
    pricingTaxIncluded: "現地税含む",
    affiliateWarRoom: "アフィリエイト・ウォールーム",
    affiliateTitle: "トップアフィリエイト",
    affiliateSubtitle: "匿名ランキングで高成果パートナーと実支払いを表示。",
    affiliateRank: "#",
    affiliatePartner: "パートナー",
    affiliateReferrals: "紹介数",
    affiliateRegion: "地域",
    affiliatePayout: "支払い",
    affiliateCtaTitle: "ここに載りたい？",
    affiliateCtaBody: "runbookを共有し、新チームを紹介—アクティブ顧客ごとに支払います。",
    affiliateCtaButton: "アフィリエイト開始 →",
    affiliateCtaSecondary: "ダッシュボードへ",
    quickFixWidgetTitle: "Quick-Fix ウィジェット",
    quickFixWidgetSubtitle: "この課題の即時修正を起動。",
    quickFixWidgetCta: "修正を開く →",
  },
  ...
  ar: {
    ...
    pricingTaxIncluded: "شامل الضرائب المحلية",
    affiliateWarRoom: "غرفة حرب الشركاء",
    affiliateTitle: "أفضل الشركاء",
    affiliateSubtitle: "تصنيف مجهول لأفضل الشركاء مع دفعات حقيقية.",
    affiliateRank: "#",
    affiliatePartner: "الشريك",
    affiliateReferrals: "الإحالات",
    affiliateRegion: "المنطقة",
    affiliatePayout: "الدفعة",
    affiliateCtaTitle: "هل تريد أن تكون هنا؟",
    affiliateCtaBody: "شارك الـ runbooks وجلب فرق جديدة — ندفع لكل عميل نشط.",
    affiliateCtaButton: "ابدأ الشراكة →",
    affiliateCtaSecondary: "افتح لوحة التحكم",
    quickFixWidgetTitle: "أداة Quick-Fix",
    quickFixWidgetSubtitle: "ابدأ إصلاحاً فورياً لهذه المشكلة.",
    quickFixWidgetCta: "افتح الإصلاح →",
  },
}
